...
type BookingStorageI interface {
	...
	DeletePatient(ctx context.Context, req *pb.DeletePatientRequest) (*pb.Patient, error)
	...
	DeleteDoctorAvailability(ctx context.Context, req *pb.DeleteDoctorAvailabilityRequest) (resp *pb.DoctorAvailability, err error)
	...
	DeleteBookedAppointment(ctx context.Context, req *pb.DeleteBookedAppointmentRequest) (*pb.BookedAppointment, error)

	// ArchiveService Methods
	// CreateArchive(ctx context.Context, req *pb.CreateArchiveRequest) (*pb.Archive, error)
	...
	// DeleteArchive(ctx context.Context, req *pb.DeleteArchiveRequest) (*pb.Archive, error)
